  ...
  return (
    <div className="h-32 p-5 header-bg bg-slate-50 border-b border-slate-300">
      <div className="flex space-x-3">
        <div className="flex w-12 h-12 rounded-lg items-center justify-center bg-white">
          <Building2 />
        </div>
        <div className="flex flex-col">
          <p className="text-slate-700 font-semibold">Hello, GQC Developer</p>
          <span className="text-sm">GQC Group</span>
        </div>
      </div>
